...
const showImages = (images) => {
  ...
  images.forEach(image => {
    ...
    div.innerHTML = `
    <img class="img-fluid img-thumbnail" onclick=selectItem(event,"${image.webformatURL}") src="${image.webformatURL}" >
    <p class='border border-dark badge badge-primary'>${image.tags}</p>`;
